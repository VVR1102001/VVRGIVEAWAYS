...
<html lang="en-IN">
  <head>
    ...
    $conn = new mysqli("sql208.epizy.com","epiz_31256379","96408971","epiz_31256379_camp");
     ...
     // echo $url;
      ...
      if(mysqli_num_rows($result)>0){
        ...
        if($cname==null||$cname==" "){
          $cname = "your campaign name appears here";
        }
    ...
    <meta name="description" content="Campaigns for earning paytm cash instantly without investing single rupee"/>
    ...
    <h2>
     ...
     // echo $url;
      ...
      if($urlid==null||$urlid==" "){
          ...
          echo "<br><br><small><b>YOU HAVE NOT CREATED CAMPAIGN LINK YET.</b></small><br><br>TO CREATE CLICK <a href='giveaways/createc.php'>Campaign Link</a>";
...
?>   
     <!--
      ...
      <br><br>
      <?php
        echo "<a href='https://telegram.dog/vvrgiveaways'>Join Channel</a>";
      }
/*
...
<br><br>        
      ...
      <script src="https://vvrgiveaways.cf/javascripts/e.js"></script>-->
  </body>
</html>