...
<select id="offers" name="offers" onchange="document.getElementById('txto').value=document.getElementById('offers').value;">
...
<input type="number" autocomplete="off" id="txt" name="OFFERNUMBER" required/>
