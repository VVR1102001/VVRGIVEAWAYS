...
<link rel="canonical" href="https://www.vvrgiveaways.ml" />
  ...
  <body onload="findUrl()" style="background-image:url(https://vvrgiveaways.cf/assets/svg/5.svg);background-repeat:no-repeat;">
    ...
    <form action="referandearn.php" method="post">
      
      <label for="number">ENTER PAYTM NUMBER</label>
      <input type="number" autocomplete="off" id="number" name="NUMBER" placeholder="Enter Paytm Number" required />
      <br><br>
      <script>
      
      </script>
      <select name = "select" id="offers" onchange="document.getElementById('txto').value=document.getElementById('offers').value;" required>
<option>camps</option>
<option value="https://hiqmobi10332158.o18.link/c?o=18266601&m=10478&a=386765">Tataneu - Register</option>
<option value="https://hiqmobi10332158.o18.link/c?o=18211212&m=10478&a=386765">Qureka - Gameplay</option>
<option value="https://hiqmobi10332158.o18.link/c?o=18248048&m=10478&a=386765">CryptoWire - Register</option>
</select><br>
<input type="txt" autocomplete="off" id="txto" name="OFFERURL" readonly style="opacity:100%;"/>
