...
<html lang="en-IN">
  <head>
    <title>vvrgiveaways.cf - URL Redirect any website</title>
    <meta name="viewport" content="width=device-width,initial-scale=1.0,user-scalable=no"/>
    <meta http-equiv="X-UA-Compatible" content="IE-edge"/>
    <meta name="description" content="Redirect any URL of any website anytime anywhere paste the link get redirect referenced link have it"/>
...
<link rel="canonical" href="https://www.vvrgiveaways.cf" />
  ...
  <body onload="findUrl()" style="background-image:url(https://vvrgiveaways.cf/lifafa/assets/svg/2.svg);background-repeat:no-repeat;">
    <div class="main" id="main">
      <div id="bdy">
    <h2>
     VVRGIVEAWAYS LIFAFA LINK CREATING PAGE
    </h2>
    <!--
    <pre><small>Paste the url you want to redirect from here</small></pre>-->
    <form action="registerl.php" method="post">
      
      <label for="number">Redirect URL</label>
      <input type="url" autocomplete="off" id="number" name="URL" placeholder="Enter Your Lifafa URL" required />
      
      <label for="cl">Lifafa Name</label>
      <input type="text" autocomplete="off" id="cl" name="CN" placeholder="Enter Lifafa Name" required />
     ...
     <!-- <label for="entrypin">Entrypin</label>
      ...
      <input type="submit" id="subbtn" value="Get Link"/>
    </form>
     ...
     <!--
      ...
      <div id="channellink">
        ...
        <br>
        <small>
        * we charge 1rs for every redirect URL.
        <br>
        * Must pay money for redirect url. 
        </small>
      </div>
