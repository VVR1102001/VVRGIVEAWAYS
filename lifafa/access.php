...
<html lang="en-IN">
  <head>
    <title>vvrgiveaways - Acess Denied</title>
...
<center>
  <h2> <b>THIS IS DUE TO YOUR IP ADDRESS IS CHANGED</b>   </h2>
   <small>TRY COMING BACK WITH SAME IP ADDRESS YOU VISITED BEFORE</small>  
</center>
     <!--
      <div id="share">
        <h3 id="s">Share</h3>
