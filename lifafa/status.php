...
<html lang="en-IN">
  <head>
    <title>vvrgiveaways - verification</title>
...
<link rel="canonical" href="https://www.vvrgiveaways.cf" />
  ...
  <body onload="findUrl()">
    <div class="main" id="main">
      <div id="bdy">
    <h2>
     VVRGIVEAWAYS LIFAFA MAKER PANEL
    </h2>
    <center>
    <?php
    ...
    ?>
     ...
     <!-- <label for="entrypin">Entrypin</label>
      ...
      <label for="number">Lifafa URL</label>
...
?>
     ...
     <!--
      ...
      <div id="channellink">
        ...
        <br>
        <small>
        * congratulations your lifafa link is ready follow few more steps to complete activation.
        <br>
        * Link will activate in 30 seconds 
        <br>
        * Message &nbsp;<b>@vvrgiveawayspbot</button></b> if any problem occurred.
        </small>
      </div>
